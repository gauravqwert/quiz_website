...
var quizApp = function () {
	...
	this.submitQuiz = function () {
		...
		this.showResult(totalScore); // Show the result

		// Show user name in alert with score
		alert("Quiz completed!\nName: " + this.userName + "\nTotal Score: " + totalScore + "/" + totalque);
	};
	...
	// Start the quiz with user's name
	...
	this.showResult = function (scr) {
		...
		$("#result").append("<h3 class='user-name'>Name: " + this.userName + "</h3>");
...
$(document).ready(function () {
	...
	$('#startQuiz').click(function () {
		...
		jsq.startQuiz(userName);
	});

	// Also allow Enter key to start quiz
